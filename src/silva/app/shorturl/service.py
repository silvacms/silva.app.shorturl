...
class ShortURLService(SilvaService):
    ...
    default_id = 'service_shorturls'
    _min_length = 4
    _block_size = 24

    def __init__(self, id):
        super(IShortURLService, self).__init__(id)
